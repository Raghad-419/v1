...
import com.example.capston3.DTO.EventRegistrationOutDTO;
...
public class EventRegistrationService {
    ...
    public List<EventRegistrationOutDTO> getEventRegistrations() {
        ...
        for (EventRegistration eventRegistration : eventRegistrations) {
            eventRegistrationOutDTOs.add(new EventRegistrationOutDTO(eventRegistration.getEvent().getId(),eventRegistration.getOwner().getId(),eventRegistration.getUser().getId()));
        }
